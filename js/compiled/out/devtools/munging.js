...
var o23028 = temp__5718__auto__;
var temp__5718__auto____$1 = (o23028["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o23029 = temp__5718__auto____$1;
return (o23029["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22386__auto__ = f;
return (o__22386__auto__["toString"]).call(o__22386__auto__);
} else {
return "";
}
}catch (e23030){var _ = e23030;
return "";
}});
...
try{var o__22386__auto___23032 = t;
(o__22386__auto___23032["cljs$lang$ctorPrWriter"]).call(o__22386__auto___23032,t,writer);
}catch (e23031){var __23033 = e23031;
}
...
var char_code = (function (){var o__22386__auto__ = (new String(char$));
return (o__22386__auto__["charCodeAt"]).call(o__22386__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22386__auto__ = String;
return (o__22386__auto__["fromCharCode"]).call(o__22386__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23034 = num_code;
switch (G__23034) {
case (1):
return (185);
...
var o__22386__auto__ = String;
return (o__22386__auto__["fromCharCode"]).call(o__22386__auto__,superscript_code);
});
/**
...
}catch (e23036){var _e__22393__auto__ = e23036;
return false;
}})())){
...
var vec__23037 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23037,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o23040 = temp__5718__auto__;
var temp__5718__auto____$1 = (o23040["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o23041 = temp__5718__auto____$1;
return (o23041["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23044){
var vec__23045 = p__23044;
var ns_detector = cljs.core.nth.call(null,vec__23045,(0),null);
...
var G__23051 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23052 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23051;
remaining_tokens = G__23052;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23042){
var G__23043 = cljs.core.first.call(null,seq23042);
var seq23042__$1 = cljs.core.next.call(null,seq23042);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23043,seq23042__$1);
}));
...
var vec__23056 = cljs.core.split_with.call(null,(function (p1__23055_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23055_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23056,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23056,(1),null);
...
var vec__23062 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23062,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23062,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23065 = cljs.core.rest.call(null,remaining_tokens);
var G__23066 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23065;
name_tokens = G__23066;
continue;
} else {
...
var vec__23069 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23069,(0),null);
var arity = cljs.core.nth.call(null,vec__23069,(1),null);
var vec__23072 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23072,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23072,(1),null);
var vec__23075 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23075,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23075,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23075,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23075,(3),null);
...
var vec__23081 = result;
var munged_ns = cljs.core.nth.call(null,vec__23081,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23081,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23081,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23081,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23081,(4),null);
var arity = cljs.core.nth.call(null,vec__23081,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__23085 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__23085,(0),null);
var args = cljs.core.nth.call(null,vec__23085,(1),null);
var vec__23088 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23088,(0),null);
var name = cljs.core.nth.call(null,vec__23088,(1),null);
...
var G__23091 = (arity + (1));
var G__23092 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23093){
var vec__23094 = p__23093;
var arity = cljs.core.nth.call(null,vec__23094,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23094,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23097_SHARP_){
return cljs.core.get.call(null,arities,p1__23097_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__23098_SHARP_){
return cljs.core.drop.call(null,(2),p1__23098_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___23105 = arguments.length;
var i__4737__auto___23106 = (0);
while(true){
if((i__4737__auto___23106 < len__4736__auto___23105)){
args__4742__auto__.push((arguments[i__4737__auto___23106]));

var G__23107 = (i__4737__auto___23106 + (1));
i__4737__auto___23106 = G__23107;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23101){
var vec__23102 = p__23101;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23102,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23099){
var G__23100 = cljs.core.first.call(null,seq23099);
var seq23099__$1 = cljs.core.next.call(null,seq23099);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23100,seq23099__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23110__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23110__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23110__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23110__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23111 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23111,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23111,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23111,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23111,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23111,(4),null);
var arity = cljs.core.nth.call(null,vec__23111,(5),null);
...
var o__22386__auto__ = f;
return (o__22386__auto__["getBasis"]).call(o__22386__auto__);
});
/**
...
}catch (e23115){var _e__22393__auto__ = e23115;
...
var G__23116 = (obj[cljs.core.first.call(null,path)]);
var G__23117 = cljs.core.rest.call(null,path);
obj = G__23116;
path = G__23117;
continue;
} else {
...
var _STAR_ = (function (accum,p__23118){
var vec__23119 = p__23118;
var bit = cljs.core.nth.call(null,vec__23119,(0),null);
var protocol = cljs.core.nth.call(null,vec__23119,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23122){
var vec__23123 = p__23122;
var ns = cljs.core.nth.call(null,vec__23123,(0),null);
var name = cljs.core.nth.call(null,vec__23123,(1),null);
var selector = cljs.core.nth.call(null,vec__23123,(2),null);
...
var post_process = (function (p__23127){
var vec__23128 = p__23127;
var munged_name = cljs.core.nth.call(null,vec__23128,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23128,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23126_SHARP_){
return (obj[cljs.core.first.call(null,p1__23126_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1603913404202
