...
var G__22068 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__22068;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__22069 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22069,ch);
...
if(("\\" === ch__$1)){
var ch_22070__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_22070__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_22070__$2);
} else {
}

var G__22071 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__22071;
continue;
}
}
...
var start_line = cljs.core.nth.call(null,vec__22079,(0),null);
var start_column = cljs.core.nth.call(null,vec__22079,(1),null);
...
var G__22082 = cljs.core.conj_BANG_.call(null,a,form);
a = G__22082;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__22083 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__22084 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__22084);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__22083);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__22085 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22085,(0),null);
var start_column = cljs.core.nth.call(null,vec__22085,(1),null);
...
var vec__22088 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22088,(0),null);
var end_column = cljs.core.nth.call(null,vec__22088,(1),null);
...
var vec__22091 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22091,(0),null);
var start_column = cljs.core.nth.call(null,vec__22091,(1),null);
...
var vec__22094 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22094,(0),null);
var end_column = cljs.core.nth.call(null,vec__22094,(1),null);
...
var vec__22097 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22097,(0),null);
var start_column = cljs.core.nth.call(null,vec__22097,(1),null);
...
var sb = (function (){var G__22103 = (new goog.string.StringBuffer());
G__22103.append(initch);
...
var G__22105 = (function (){var G__22104 = sb;
G__22104.append(ch);

return G__22104;
})();
var G__22106 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__22105;
ch = G__22106;
continue;
}
...
switch (G__22109) {
case "\\":
var G__22113 = (function (){var G__22110 = sb;
G__22110.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__22110;
})();
var G__22114 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22113;
ch = G__22114;
continue;
...
break;
default:
var G__22115 = (function (){var G__22111 = sb;
G__22111.append(ch);

return G__22111;
})();
var G__22116 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22115;
ch = G__22116;
continue;
...
var vec__22117 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22117,(0),null);
var end_column = cljs.core.nth.call(null,vec__22117,(1),null);
...
var vec__22120 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22120,(0),null);
var column = cljs.core.nth.call(null,vec__22120,(1),null);
...
var start_line = cljs.core.nth.call(null,vec__22135,(0),null);
var start_column = cljs.core.nth.call(null,vec__22135,(1),null);
...
var vec__22138 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22138,(0),null);
var end_column = cljs.core.nth.call(null,vec__22138,(1),null);
...
var G__22141 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__22141,true,null,opts,pending_forms);
...
var G__22142 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__22142)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__22142)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__22142)){
...
var _STAR_suppress_read_STAR__orig_val__22143 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__22144 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__22144);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__22143);
}});
...
var G__22145 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__22145,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__22145,rdr,first_line);
...
var G__22149 = matched;
var G__22150 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__22149;
finished = G__22150;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__22151 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__22152 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__22152);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__22151);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__22153 = cljs.tools.reader.arg_env;
var arg_env_temp_val__22154 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__22154);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__22155 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22155,"(");
...
var G__22156 = (i + (1));
var G__22157 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__22153);
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__22158 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__22158);
...
var G__22159 = cljs.core.next.call(null,s__$1);
var G__22160 = ret;
s__$1 = G__22159;
r = G__22160;
continue;
...
var G__22161 = cljs.core.next.call(null,s);
var G__22162 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__22161;
key_vals = G__22162;
continue;
} else {
...
var gensym_env_orig_val__22167 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__22168 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__22168);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__22167);
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__22169 = token;
var G__22169__$1 = (((G__22169 == null))?null:cljs.core.subs.call(null,G__22169,(1)));
var G__22169__$2 = (((G__22169__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22169__$1));
var G__22169__$3 = (((G__22169__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22169__$2));
var G__22169__$4 = (((G__22169__$3 == null))?null:cljs.core.symbol.call(null,G__22169__$3));
if((G__22169__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__22169__$4);
}
})():(function (){var G__22170 = token;
...
}catch (e22177){if((e22177 instanceof Error)){
var e = e22177;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__22181,reader){
...
var opts = map__22182__$1;
var eof = cljs.core.get.call(null,map__22182__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1603913403297
