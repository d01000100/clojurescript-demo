...
return (new CustomEvent(event_name,(function (){var obj28576 = ({"detail":data});
return obj28576;
})()));
} else {
...
var f = (function (){var pred__28583 = cljs.core._EQ_;
var expr__28584 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28583.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28584))){
return (function (p1__28577_SHARP_){
return console.warn(p1__28577_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28583.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28584))){
return (function (p1__28578_SHARP_){
return console.debug(p1__28578_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28583.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28584))){
return (function (p1__28579_SHARP_){
return console.error(p1__28579_SHARP_);
});
} else {
return (function (p1__28580_SHARP_){
return console.log(p1__28580_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28587){
...
var opts = map__28588__$1;
var eval_fn = cljs.core.get.call(null,map__28588__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__28590_SHARP_){
return new_def.callback(p1__28590_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__28591){
var vec__28592 = p__28591;
var ky = cljs.core.nth.call(null,vec__28592,(0),null);
var v = cljs.core.nth.call(null,vec__28592,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1603913408875
